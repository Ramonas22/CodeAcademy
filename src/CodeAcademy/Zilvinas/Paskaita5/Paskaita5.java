package CodeAcademy.Zilvinas.Paskaita5;
...
public class Paskaita5 {
    ...
    public static void pilanametis() {
    ...
    public static void amziausCenzas() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Ivesktie savo amziu");
    ...
    public static void spausdintiMenesi() {
        Scanner scanner = new Scanner(System.in);
