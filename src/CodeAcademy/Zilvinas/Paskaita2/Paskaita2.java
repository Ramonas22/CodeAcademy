package CodeAcademy.Zilvinas.Paskaita2;

import java.util.Scanner;

public class Paskaita2 {

    public static void UzduotisPirma() {
    ...
    public static void UzduotisAntra(){
    ...
    public static void Vienas(String tekstas2){
        /*
    ...
    public static void Antras(String[] args){
