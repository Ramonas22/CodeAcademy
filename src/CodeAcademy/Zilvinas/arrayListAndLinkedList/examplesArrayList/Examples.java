package CodeAcademy.Zilvinas.arrayListAndLinkedList.examplesArrayList;
...
class Examples {
    ...
    * */
    ...
    private static void loopingExamples() {
    ...
    private static void combiningListsExample(){
    ...
    private static void swappingElementsInList(){
        ArrayList<String> cities = new ArrayList<>();
    ...
    private static void primitiveElementsInList(){
